...
```bash
git clone [https://github.com/jeroval/fedora-auto-update-installer.git](https://github.com/jeroval/fedora-auto-update-installer.git)
...
- DNF5
- Flatpak
- fwupd# Fedora Auto Update Installer
